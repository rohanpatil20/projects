...
public class PaintFileParserTest {
	...
	public void parserTest18() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_fail_negativepoints.txt",
				"Returns false for multiple squiggle with negative co-ordinates", "Error in line 6 ");
	}
	@Test
	public void parserTest19() throws IOException {
		this.doParserTestCase("samplefiles/multishapes_complex.txt",
